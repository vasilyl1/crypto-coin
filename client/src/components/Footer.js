                ...
                <footer className="py-5">
                    <div className="row">
                        ...
                        <div className="col-6 col-md-4 mb-3">
                            <h5>Account</h5>
                            <ul className="nav flex-column">
                                <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted">Subscriptions</a></li>
                        ...
                        <div className="col-6 col-md-4 mb-3">
                            <h5>Contact</h5>
                            <ul className="nav flex-column">
                                <li className="nav-item mb-2 text-muted">1234 Main St</li>
                                <li className="nav-item mb-2 text-muted">New York, NY 12345</li>
                                <li className="nav-item mb-2 text-muted">Phone: 555-555-5555</li>
                                <li className="nav-item mb-2 text-muted">Email: info@crypto-coin.com</li>
                            </ul>
                        </div>
                    ...
                    <div className="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top text-center">
                        <p className="text-center">&copy; 2023 Crypto-Coin Inc. All rights reserved.</p>
                ...
                <Container>
                    <Row>
                        <Col md={6}>
                            ...
                            <p className="mb-1">1234 Main St</p>
                            <p className="mb-1">New York, NY 12345</p>
                            <p className="mb-1">Phone: 555-555-5555</p>
                            <p className="mb-1">Email: info@crypto.com</p>
                            &nbsp; &nbsp;
                        ...
                        <Col md={6} className="d-flex justify-content-md-end justify-content-center">
                            <ul className="list-unstyled mb-1 mt-5">
                                <li><a href="#" className="link-light link-underline-opacity-0">Privacy Policy</a></li>
                                <li><a href="#" className="link-light link-underline-opacity-0">Terms and Conditions</a></li>
                            </ul>
                        </Col>
                    </Row>
